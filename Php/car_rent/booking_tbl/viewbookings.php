 ...
 <th>Reject</th> 
  ...
  // $i=0;
   echo "<tbody>";
 	...
 	$result = mysqli_query($con,"SELECT * FROM $table WHERE status!='paid'");
       ...
       $result2 = mysqli_query($con, $sql2) or die("Error in Selecting " .mysqli_error($connection));
        $row2 =mysqli_fetch_array($result2);
			...
			<td><a href='accept.php?id=$id' style='color:green;font-weight: bold;'>Approve</a></td>
			
			<td><a href='reject.php?id=$id' style='color:red;font-weight: bold;'>Reject</a></td>
